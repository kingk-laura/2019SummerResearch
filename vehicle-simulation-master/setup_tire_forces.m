...
%     
    ...
    % Obtain steering angle by differentiating variable stored as its integral
    % x(23) = integral of steering angle  
    % delta_sim = derivative of x(23), obtained from differentiator.mdl
...
[Ftire_lat_fl_vec(ijk,1),Ftire_long_fl_vec(ijk,1)] = tire_model(slip_angle_fl,slip_ratio_fl,Fz);
[Ftire_lat_fr_vec(ijk,1),Ftire_long_fr_vec(ijk,1)] = tire_model(slip_angle_fr,slip_ratio_fr,Fz);
[Ftire_lat_rl_vec(ijk,1),Ftire_long_rl_vec(ijk,1)] = tire_model(slip_angle_rl,slip_ratio_rl,Fz);
[Ftire_lat_rr_vec(ijk,1),Ftire_long_rr_vec(ijk,1)] = tire_model(slip_angle_rr,slip_ratio_rr,Fz);
